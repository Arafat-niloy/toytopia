...
const ToyCard = ({ toy }) => {
    ...
    const { toyId, toyName, pictureURL, rating, availableQuantity, price, description } = toy;

  return (
    <div className="card bg-base-100 shadow-xl border h-full flex flex-col">
      <figure className="px-10 pt-10 h-64">

        <img src={pictureURL} alt={toyName} className="rounded-xl object-cover h-full w-full" />
      </figure>
